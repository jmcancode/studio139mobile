  ...
  return (
    <SafeAreaView>
      ...
      >
          ...
          return (
            <View key={`block-${index}`}>
              {index % 3 === 1 && (
                <Image
                  source={{
                    uri: `https://source.unsplash.com/600x${
                      400 + index
                    }/?blackandwhite`,
                  }}
                  style={styles.image}
        ...
        />
        <View
          style={{ borderTopColor: "#333", borderTopWidth: 1, marginTop: 20 }}
        >
          ...
          {articleParagraphs.slice(3, 9).map((text, index) => {
            return (
              ...
              >
                <Image
                  source={{
                    uri: `https://source.unsplash.com/100x${
                      100 + index
                    }/?blackandwhite`,
                  }}
      ...
      {actionLayout && (
        ...
        >
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <Entypo name="export" size={24} color={colors.text} />
            </Animated.View>
            <Animated.View
              style={[
                styles.icon,
            ...
            >
              <Entypo name="share-alternative" size={24} color={colors.text} />
            </Animated.View>
          </View>
        </Animated.View>
      )}
